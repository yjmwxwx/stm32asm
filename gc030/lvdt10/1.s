...
qq:
	...
	.equ caiyang90zhizhen,		0x20000020
	.equ caiyang90,			0x20000024
	.equ caiyang270zhizhen,		0x20000120
	.equ caiyang270,		0x20000124
	.equ adczhengfu,		0x20000104	@1正0负
.section .text
vectors:
	.word STACKINIT
	.word _start + 1
...
_jianbo270du:
	...
	ldr r4, = 32
	ldr r1, = caiyang90zhizhen
	ldr r2, = caiyang90
	ldr r0, = caiyang270zhizhen
	ldr r7, = caiyang270
	ldr r3, [r1]
	lsls r4, r4, # 2
	adds r3, r3, # 4
