...
qq:
	...
	.equ lvbozhizhen1,		0x20000120
	.equ lvbohuanchong1,		0x20000124
...
_lcdchushihua:
	...
	movs r6, # 16
_denglvboqihuanchongman:	        @等滤波器缓冲区满
	bl _lvdtfuzhi
	subs r6, r6, # 1
	bne _denglvboqihuanchongman
...
_lvdtzhengfuxianshi:
        ...
        bl _lvdtfuzhi1           @计算LVDT传感器幅值
        mov r4, r0
        cmp r1, # 1
        beq _lvdtzheng1
        ldr r1, = jian
        b _lvdtzhengfuxianshi1
_lvdtzheng1:
        ldr r1, = jia
_lvdtzhengfuxianshi1:
        movs r0, # 0xc8         @LCD位置
        movs r2, # 1            @长度
        movs r3, # 0xff         @没小数点
        bl _lcdxianshi
...
_lvdtfuzhi1:
	...
	bl _jianbo                      @检波90、270
        ...
        mov r4, r1
        mov r3, r0
        ldr r0, = lvbohuanchong1         @滤波器缓冲区
        movs r1, # 16                    @级数
        ldr r2, = lvbozhizhen1           @滤波器指针
        bl _lvboqi                      @平滑，平均滤波器
        mov r1, r4
