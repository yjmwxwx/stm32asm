...
qq:
	...
	.equ iozhongduanshu,		0x20000014
	.equ zhuansu,			0x20000018
	.equ shijian360zhizhen,		0x2000001c
	.equ shijian360caiyang,		0x20000020
.section .text
vectors:
	.word STACKINIT
	.word _start + 1
...
_waibuzhongduan:
	ldr r0, = 0x40010400	@EXTI_IMR中断屏蔽
	ldr r1, = 0x0ff40001	@PA0
	movs r2, # 0x01		@pa0
	str r1, [r0]
	str r2, [r0, # 0x08]	@EXIT_RTSR上升沿
