...
pi_pei_jiao_zhun:
	...
	.equ shangbi_r,			0x20000184
	.equ shangbi_i,			0x20000188
	.equ xiabi_r,			0x2000018c
	.equ xiabi_i,			0x20000190
...
__xia_bi_dian_ya_cai_yang:
	push {r1-r4,lr}
	ldr r0, = zhengxiangbiao
	movs r1, # 0
	mov r4, r1
	ldr r2, = 256
__xia_bi_cai_yang_xun_huan:	
	ldrh r3, [r0, r1]
	adds r4, r4, r3
	adds r1, r1, # 2
	subs r2, r2, # 1
	bne __xia_bi_cai_yang_xun_huan
	cmp r4, # 100
	bcs __xia_bi_cai_yang_fan_hui
	movs r0, # 1
__xia_bi_cai_yang_fan_hui:	
	pop {r1-r4,pc}
