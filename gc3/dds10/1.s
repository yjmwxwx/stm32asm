...
.section .data	
		...
		.equ shumaguanma,	      0x20000000
	        .equ zhengxianchushizhi,      0x20000010
	        .equ zhengxianyiweizhi,       0x20000014
	        .equ zhengxianzengjian,       0x20000018
		.equ zhengxianzhuangtai,      0x2000001c
...
_systick:
	...
	pop {r0-r7,pc}
_tim14:
	@ 初输两参，初值又移值，初值取于2c分2, 移值需设
	push {r0-r7,lr}
	ldr r7, = 0x40002000
	ldr r0, [r7, # 0x2c]
	lsrs r0, # 1
	ldr r1, = zhengxianyiweizhi
	ldr r3, [r1]
	mov r8, r0
	ldr r5, = zhengxianzengjian
	ldr r0, [r5]
	ldr r2, = zhengxianzhuangtai
	ldr r1, [r2]
	cmp r1, # 0
	beq _zhengxianjia
	cmp r1, # 1
