...
loc_C:					@ CODE XREF: cr4_fft_64_stm32+9Aj
		ADD.W	LR, R1,	R12,LSR#26
						@ 0x8000000
						@ 高16实，低16虚
		LDRSH.W	R5, [LR,#2]		@ 高 r5 = 0x2000
		LDRSH.W	R4, [LR],#0x40		@ 低 r4 = 0x5000
	
						@ 0x8000040
		LDRSH.W	R9, [LR,#2]		@ r9 = 0x6d6a
		LDRSH.W	R8, [LR],#0x40          @ r8 = 0x7920
	
						@ 0x8000080
		LDRSH.W	R7, [LR,#2]		@ r7 = 0x0b4b
		LDRSH.W	R6, [LR],#0x40		@ r6 = 0xffffeba9

						@ 0x80000c0
		LDRSH.W	R11, [LR,#2]		@r11 = 0xffff8047
		LDRSH.W	R10, [LR],#0x40		@ r10 = 0x22e95fe4
