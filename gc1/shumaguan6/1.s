...
caidian: .word zhucaidan +1,dd1 +1,dd2 +1,dd3 +1,dd4 +1,dd5 +1,dd6 +1,dd7 +1,dd8 +1,dd9 +1,dd10 +1,dd11 +1,dd12 +1,dd13 +1,dd14 +1,dd15 +1,dd16 +1,dd17 +1,dd18 +1,dd19 +1,dd20 +1,dd21 +1
	
        	.equ STACKINIT,          0x20005000
		.equ systickbiaozhi,     0x20000300
		.equ dq18b20,		 0x42210184
.section .text
xiangliangbiao:
	.word STACKINIT
	.word _start + 1
...
fuwei18b20:
	...
	mov r1, # 0x02
	str r1, [r0, # 0x14]
	mov r11, # 0 @ psc     72000除PSC=计数频率
	ldr r10, = 38888 @ arr ARR 除 计数频率= MS 
	bl tim3yanshi
tim3cs1:
	ldr r11, [r12, # 0x10]
	lsls r11, # 31
